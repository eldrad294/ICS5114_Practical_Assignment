...
class VideoRecorder(Spout):
    ...
    Responsible for offloading streaming objects containing video data (both real-time and prerecorded).
    """
    # Grouping Mechanism
    outputs = ['video']
    ...
    def next_tuple(self):
        """
        Submitter method for Spout, emits captured and segmented video file paths
        :return: None
        """
        try:
